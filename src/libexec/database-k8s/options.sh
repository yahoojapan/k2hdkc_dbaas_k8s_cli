...
parse_dbaas_k8s_option()
{
	...
	while [ $# -gt 0 ]; do
		...
		if [ -z "${_OPTION_TMP}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CONFIG_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_DOMAIN_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_K8SNAMESPACE_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_K8SDOMAIN_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_LONG}" ]; then
			...
			if [ -z "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" ] || { [ "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" != "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_ALL}" ] && [ "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" != "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_CA}" ] && [ "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" != "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_R3DKC}" ] && [ "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" != "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_R3API}" ] && [ "${_OPT_TMP_DBAAS_K8S_CERT_TYPE}" != "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_R3APP}" ]; }; then
				prn_err "Unknown ${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_TYPE_LONG} option value(${_OPT_TMP_DBAAS_K8S_CERT_TYPE})."
				return 1
			fi

		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3DKC_NAME_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3APP_NAME_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3API_NAME_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_HOST_NUM_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3DKC_REPS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3API_REPS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3APP_REPS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3API_EP_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3APP_EP_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3API_NPNUM_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_R3APP_NPNUM_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_NODE_IPS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_MINIKUBE_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_FORCE_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_SUSPEND_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_C_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_S_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_O_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CA_PASS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CERT_EXPIRE_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_SHOW_CONFIG_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_SHOW_RES_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_SHOW_SUMMARY_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_RM_CERTS_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_CLIENT_SECRET_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_CLIENT_ID_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_ISSUER_URL_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_USERNAME_KEY_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_COOKIENAME_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_OIDC_COOKIE_EXPIRE_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_K8S_API_URL_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_K8S_CA_CERT_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_K8S_SA_TOKEN_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CLUSTER_SVR_PORT_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CLUSTER_SVR_CTLPORT_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CLUSTER_SLV_CTLPORT_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CLUSTER_SVR_CNT_LONG}" ]; then
		...
		elif [ "${_OPTION_TMP}" = "${K2HR3CLI_DBAAS_K8S_COMMAND_OPT_CLUSTER_SLV_CNT_LONG}" ]; then
